...
export function destructure_table_name (table_name: string, fallback_namespace?: string)
  : {table_name: string, namespace?: string} {
  ...
  if(!!fallback_namespace)
    return {table_name: sp[0], namespace: fallback_namespace};
